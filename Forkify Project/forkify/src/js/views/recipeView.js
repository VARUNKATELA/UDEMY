...
const createIngrediant = ingrediant => 
`
<li class="recipe__item">
    <svg class="recipe__icon">
        <use href="img/icons.svg#icon-check"></use>
    </svg>
    <div class="recipe__count">${formateCount(ingrediant.count)}</div>
...
export const recipeRender = (recipe, isLiked )=> {
    ...
    `<figure class="recipe__fig">
            ...
            <div class="recipe__ingredients">
                ...
                ${recipe.ingrediant.map(el => createIngrediant(el)).join('')}
                </ul>
...
export const updateServingsIngredients = recipe => {
    ...
    countElements.forEach((el, i) => {
      el.textContent = formateCount(recipe.ingrediant[i].count);
    });
};